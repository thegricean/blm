...
We operationalized prior beliefs about the world as a listener's membership in the group referenced in a given statement, as well as their subjective perception of the likeability of that group. We assessed subject judgment of group likability as a reasonable probe of their prior beliefs about the group because it is more explicit in terms of a negative or positive sentiment towards a group being referenced in a statement like "Black lives matter" and thus may yield more pronounced effects with regards to strength of exhaustivity inference. However, we still aimed to investigate the role of group membership, in the case where membership may be more salient to exhaustivity inference than perceived likability.

We will present results from two experiments that make up an intial effort to thoroughly examine how and why exhaustivity inferences change in terms of strength and incidence depending on the listener's relationship to the group implicated in a given statement. Experiment 1 is a norming study ensuring integrity of our stimuli insofar as they are actually positively, negatively, or neutrally valenced. Then, Experiment 2 tests our primary hypotheses that the misunderstanding of "Black lives matter" is an incorrectly and strongly drawn exhaustivity inference affected by the prior beliefs a listener has, operationalized by how likable they find a group implicated in a statement and whether or not they identify as a member of that group. 


## Experiment 1 ##
The initial norming experiment was intended to obtain participant ratings of 36 different predicates on a sliding scale in order to determine which predicates were considered highly positive, highly negative, and neutral in valence. We used the results of this experiment to determine which predicates would be used in the target experiment. 
...
##References##
Johnson-Laird, P. N. (1993). Human and Machine Thinking. Hillsdale, New Jersey: Lawrence Erlbaum Associates, Inc. Publishers.
