...
![Norming means](https://github.com/thegricean/blm/blob/master/results_experiments/1_norming/graphs/means.pdf?raw=true "Figure 1. Mean rating of predicates tested in the norming study, clustered according to their hypothesized category (positive, negative, and neutral).")
